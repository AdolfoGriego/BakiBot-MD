...
this.sendMessage(m.chat, {text: `${lenguajeCD['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝐁𝐚𝐤𝐢𝐁𝐨𝐭-𝐌𝐃 ', previewType: 0, thumbnail: imagen9, sourceUrl: nn }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeCD['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeCD['smsCont10']()} *${_user.level}* ${lenguajeCD['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝐁𝐚𝐤𝐢𝐁𝐨𝐭-𝐌𝐃 ', previewType: 0, thumbnail: imagen9, sourceUrl: nn }}}, { quoted: m })         
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝐁𝐚𝐤𝐢𝐁𝐨𝐭-𝐌𝐃') :
