...
❏ 🔗 *𝙻𝙸𝙽𝙺:* ${yt_play[0].url}`.trim();
    ...
    let buttonMessage = {
      document: { url: "https://wa.me/521528451003894" },
      ...
      contextInfo: {
        ...
        externalAdReply: {
          ...
          sourceUrl: `https://github.com/AdolfoGriego/BakiBot-MD`,
        },
      },
    };
...
❏ 🔗 *𝙻𝙸𝙽𝙺:* ${urll}`.trim()
let buttonMessage = { "document": { url: "https://wa.me/5218451003894" }, "fileName": '❏ 🌿 ʀᴇᴘʀᴏᴅᴜᴄᴛᴏʀ ᴅᴇ ʏᴏᴜᴛᴜʙᴇ', "mimetype": 'application/vnd.ms-excel', "caption": texto1, "fileLength": '99999999999999', "mentions": [m.sender], "footer": wm, "buttons": buttons, "headerType": 4, contextInfo: { "mentionedJid": [m.sender], "externalAdReply": { "showAdAttribution": true, "title": `${title}`, "mediaType": 2, "previewType": "VIDEO", "thumbnail": await (await fetch(thumbnail)).buffer(), "mediaUrl": `${urll}`, "sourceUrl": `https://github.com/AdolfoGriego/BakiBot-MD` }}} 
conn.sendMessage(m.chat, buttonMessage, { quoted: m })
} catch {
try {
