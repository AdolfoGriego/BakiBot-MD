...
conn.sendButton(m.chat, `_🥵 Pack 🥵_`, author, url, [['🔁SIGUIENTE🔁', `${usedPrefix + command}`]], m)
break
case "pack2":  
let url2 = await packgirl[Math.floor(Math.random() * packgirl.length)]
conn.sendButton(m.chat, `_🥵 Pack 2 🥵_`, author, url2, [['🔁SIGUIENTE🔁', `${usedPrefix + command}`]], m) 
break
case "pack3":
let url3 = await packmen[Math.floor(Math.random() * packmen.length)]
conn.sendButton(m.chat, `_🥵 Pack 3 🥵_`, author, url3, [['🔁SIGUIENTE🔁', `${usedPrefix + command}`]], m) 
break
case "videoxxx": case "vídeoxxx":    
let url4 = await videosxxxc[Math.floor(Math.random() * videosxxxc.length)] 
await conn.sendButton(m.chat, `*ᴅɪsғʀᴜᴛᴀ ᴅᴇʟ ᴠɪᴅᴇᴏ 🥵*`, author, url4, [['🔁SIGUIENTE🔁', `${usedPrefix + command}`]], m)  
break  
...
await conn.sendButton(m.chat, `*ᴅɪsғʀᴜᴛᴀ ᴅᴇʟ ᴠɪᴅᴇᴏ 🥵*`, author, url5, [['🔁SIGUIENTE🔁', `${usedPrefix + command}`]], m)    
break    
}}
