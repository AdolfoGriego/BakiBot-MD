import{mediafiredl as e}from"@bochilteam/scraper";let handler=async(r,{conn:i,args:a,command:l})=>{if(!a[0])return r.reply("*✳️ Y el Link de mediafire?*");if(!isUrl(a[0])&&!a[0].includes("https://www.mediafire.com/"))return r.reply("*📌 El link es invalido*\n_Por favor, use un link de MediaFire_");try{let n=await e(a[0]),{url:t,url2:d,filename:m,ext:o,aploud:p,filesize:c,filesizeH:h}=n,s=`
*✍️ Nombre:* ${m}
*🗿 Tama\xf1o:* ${h}
*👨‍💻 Extensi\xf3n:* ${o}
*📆 Fecha de subida:* ${p}
